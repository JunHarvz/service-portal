...
export default function NavBar({onLogOut}) {
    ...
    return (
    <div className="navbar bg-base-200 shadow-sm bg-gradient-to-r from-blue-300 to-blue-400">
      <div className="navbar-start">
        <label htmlFor="my-drawer" className="btn btn-neutral border-none h-10 w-10 drawer-button bg-transparent">
          ☰
        </label>
          <a className="btn btn-ghost text-md bg-transparent border-none">
          ...
          >
            ...
            <li>
              <button
                ...
                className="btn btn-sm text-black hover:scale-105 transition-transform duration-400 shadow">
                Logout
              </button>
            </li>
          </ul>
